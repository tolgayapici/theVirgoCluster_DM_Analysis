...
__version__ = "$Id: plotMercator.py 34716 2016-09-22 21:14:00Z criviere $"
...
def main():
    ...
    p.add_argument("--contourscolor", dest="contourscolor",nargs='*',
                   default=None, help="Draw options for contours")
    p.add_argument("--contoursstyle", dest="contoursstyle",
                   default=None, help="Draw options for contours")
    p.add_argument("--contourswidth", dest="contourswidth",
                   default=None, help="Draw options for contours")
    ...
    p.add_argument("--cross", dest="cross", action="store_true",
    ...
    p.add_argument("--nofill", dest="nofill", action="store_true",
    ...
    p.add_argument("--dmer", dest="dmer", type=float, default=1.,
    ...
    p.add_argument("--onlystats", action="store_true", default=False
                   , help="Exits after returning min, max and value at center. If map is called 'flux', it will give the error if there is a map called 'flux_error'")
    ...
    p.add_argument("--contourmap", dest="contourmap", default=None,
                   help="Healpix map from which to grab contours.")
    p.add_argument("--contourmapcoord", dest="contourmapcoord", default="G",
    ...
    p.add_argument("--gaussfit", dest="gaussfit", default=None,
    ...
    n, bins, patches = plt.hist(values[seenpix], bins=int(np.sqrt(len(seenpix))), label="Data")
